...
def waber(freq, state):

    # source 1: spatial parabola
    g0 = fn.linear_window(0, 5, state.v)
    s0 = fn.parabola(1, g0)

    f0 = fn.parabola(2, osc.saw(4.5, state.t))
    ...
    f1 = 0.5 + 0.5 * math.sin(1 * freq * state.t + math.pi )
    ...
    f2 = 0.5 + 0.5 * math.cos(0.5 * freq * state.t + math.pi * 2)
    ...
    f3 = fn.parabola(2, osc.saw(4.5, state.t + 2.5))
